...
public class UserDaoTest {
	...
	@Before
	public void setUp() {
		this.user0 = new User("test1", "º€¡÷«Â", "P@ssw0rd", "test1@test.com", Level.BASIC, 1, 0);
		this.user1 = new User("test2", "¿Ã¡¯»£", "P@ssw0rd", "test2@test.com", Level.SILVER, 55, 10);
		this.user2 = new User("test3", "ø¡Ω¬√∂", "P@ssw0rd", "test3@test.com", Level.GOLD, 100, 40);
		this.user3 = new User("test4", "¿ÃªÛπŒ", "P@ssw0rd", "test4@test.com", Level.SILVER, 22, 21);
	}
